...
function IsVirtualPrinter([string]$printerDeviceID)
{
    ...
    [bool]$result = $false
    $virtualPrinterDeviceIDs = ("Microsoft XPS Document Writer", "Send To OneNote 2007" , "Microsoft Office Live Meeting 2007 Document Writer", "Fax", "Journal Note Writer")
        ...
        if($cbNeeded -gt 0)
        {
            ...
            try
            {
                ...
                if ($bRet)
                {
                    ...
                    $info2 = [System.Runtime.InteropServices.Marshal]::PtrToStructure($pAddr, $PRINTER_INFO_2.GetType())
